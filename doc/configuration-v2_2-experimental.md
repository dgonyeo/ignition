...
* **ignition** (object): metadata about the configuration itself.
  ...
  * **_security_** (object): options relating to network security.
    * **_tls_** (object): options relating to TLS when fetching resources over HTTPS.
      * **_certificateAuthorities_** (list of object): the list of additional certificate authorities (in addition to the system authorities) to be used for TLS verification when fetching over HTTPS.
